...
def test_lincoln_index_problem():
    ...
    # want to estimate how many bugs are really in the program.
    #
    # You know there are at least 20 bugs,
    # and if you have supreme confidence in your tester, you may suppose there are around 20 bugs.
    # But maybe your tester isn't very good.
    # Maybe there are hundreds of bugs. How can you have any idea how many bugs there are?
    # There's no way to know with one tester.
    # But if you have two testers, you can get a good idea,
    # even if you don't know how skilled the testers are."
    #
    # Then he presents the Lincoln index, an estimator
    # "described by Frederick Charles Lincoln in 1930,"
    # where Wikpedia's use of "described" is a hint that the index is
