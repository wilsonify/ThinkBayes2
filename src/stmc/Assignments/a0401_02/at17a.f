...
C
      OPEN(IUD,FILE='acor17a.d',FORM='formatted',STATUS='unknown')
      WRITE(IUO,*) ' '
      DO IT=0,NT
...
C
      OPEN(IUD,FILE='at_int17a.d',FORM='formatted',STATUS='unknown')
     ...
     &                IT,ACINT(IT),ACM,ACE
        ...
        WRITE(IUD,'(1I6,3F14.8,1F14.4)') (3*IT+30),
     &    (0.3+0.8*ACINT(IT)),ACM,0.8*ACE,ABIAS
      END DO
      CLOSE(IUD)
C
      STOP
