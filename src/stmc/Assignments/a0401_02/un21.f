      PROGRAM UN21 ! Version of UNCOR_GAU
C
...
C
      ...
      PARAMETER(K=21,NDAT=2**K,NBINS=32,LMEAN=.FALSE.,A=THREE,NT=127)
...
C
      OPEN(IUD,FILE='uacor21.d',FORM='formatted',STATUS='unknown')
      REWIND IUD
      WRITE(IUO,*) ' '
      DO IT=0,NT
     ...
     &                IT,ACOR(IT),ACM,ACE
      ...
      IF(LTEST) STOP "LTEST."
C
      OPEN(IUD,FILE='uat_int21.d',FORM='formatted',STATUS='unknown')
      REWIND IUD
