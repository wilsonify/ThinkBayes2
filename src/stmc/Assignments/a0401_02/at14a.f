...
C
      OPEN(IUD,FILE='acor14a.d',FORM='formatted',STATUS='unknown')
      WRITE(IUO,*) ' '
      DO IT=0,NT
...
C
      OPEN(IUD,FILE='at_int14a.d',FORM='formatted',STATUS='unknown')
     ...
     &                IT,ACINT(IT),ACM,ACE
        ...
        WRITE(IUD,'(1I6,3F14.8,1F14.4)') (75+3*IT),
     &    (0.7+0.5*ACINT(IT)),ACM,0.5*ACE,ABIAS
      END DO
      CLOSE(IUD)
C
      STOP
