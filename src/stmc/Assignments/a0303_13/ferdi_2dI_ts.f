...
C
      ...
      PARAMETER (IUO=6,IUD=10,NL=80,ML=80,NS=ML*NL,NLL=2*NL-1)
      PARAMETER (NBETA=001,DBETA=FOUR/TEN)
      ...
      DO IBETA=1,NBETA
        ...
        OPEN(IUD,FILE="2dI_ts_ferdi.d",
     &       FORM="FORMATTED",STATUS="UNKNOWN")
        WRITE(IUD,'(2F10.4)') ZERO,UENG
        WRITE(IUD,'(2F10.4)') (200*ONE),UENG
      END DO
      CLOSE(IUD)
      STOP
      END
