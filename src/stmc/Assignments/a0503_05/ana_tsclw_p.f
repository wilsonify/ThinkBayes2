      program ana_tsclw_p
C Copyright, Bernd Berg, Oct 26 2002. Potts model, time series analysis,
...
C NSTEP   Step size for the data of the plot.
      PARAMETER(NT=032,NBINS=32,NSTEP=1,LMEAN=.TRUE.)
      ...
      ltest=.true.
      ltest=.false.
      if(ltest) stop "ana_tsclw_p: ltest."
C
      ns=nsfun(nla,nd)
...
C
      ...
      open(iud1,file="a"//cq//"_"//cd//"d"//cl//"clw.d",
