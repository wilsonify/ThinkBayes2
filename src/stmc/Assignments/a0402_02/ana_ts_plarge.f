      program ana_ts_plarge ! A variant of ana_ts_p.f.
...
C -- Write-out do-loop change to enable nicer joined plot together 
C    with the ana_ts1_p.f data output.
...
C NSTEP   Step size for the data of the plot.
      PARAMETER(NT=8192,NBINS=32,NSTEP=128,LMEAN=.TRUE.)
...
C
      ...
      open(iud1,file="ta"//cq//"_"//cd//"d"//cl//".d",
     &          form="formatted",status="unknown")
      DO IT=(NSTEP/2),NT,NSTEP
