      program p_hb_tsm
C Copyright, Bernd Berg, Jan 22 2004. Potts model heat bath updating.
C MC prodcution run to create energy (action variable) time series,
C using mean values averaged over the updates of a sweep.
...
C
      ...
      write(cq,'(I2.2)') nq
      write(cl,'(I3.3)') nla(1)
      open(iud1,file="p"//cq//"_"//cd//"d"//cl//"hbm.d",
