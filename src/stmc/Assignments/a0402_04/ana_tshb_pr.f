      program ana_tshbr
C Copyright, Bernd Berg, Oct 21 2002. Potts model, time series analysis,
C prepares plots (heat bath). Calculates the average energy (action).
...
c     PARAMETER(NT=512,NBINS=32,NSTEP=16,LMEAN=.TRUE.)
c     PARAMETER(NT=256,NBINS=32,NSTEP=08,LMEAN=.TRUE.)
c     PARAMETER(NT=064,NBINS=32,NSTEP=01,LMEAN=.TRUE.)
      PARAMETER(NT=016,NBINS=32,NSTEP=01,LMEAN=.TRUE.)
...
C
      ...
      open(iud1,file="a"//cq//"_"//cd//"d"//cl//"hbr.d",
