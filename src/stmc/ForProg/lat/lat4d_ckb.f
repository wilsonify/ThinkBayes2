...
C
      write(iuo,*) " "
      write(iuo,*) " is  ic  isc   icpf(1,isc,ic) (2,) (3,) (4,)",
     &                           "  icpb(1,isc,ic) (2,) (3,) (4,)"
      do is=1,ns
        ic=iac(is)
        isc=iasc(is)
        write(iuo,'(3I4,I10,I11,2I5,I10,I11,2I5)') is,ic,isc,
     &       (icpf(id,ic,isc),id=1,nd),(icpb(id,ic,isc),id=1,nd)
      end do
      if(ltest) stop "lat4d_ckb: ltest."
C
      write(iuo,*) " "
      write(iuo,*) "Consistency check:"
      write(iuo,*) " "
      write(iuo,*) " is   ipf(1,is) (2,) (3,) (4,)",
     &                "   ipb(1,is) (2,) (3,) (4,)"
c
      do is=1,ns
        ic=iac(is)
        ...
        write(iuo,'(I4,1I8,I7,2I5,I10,I7,2I5)') is,
     &    (icpf(id,ic,isc),id=1,nd),(icpb(id,ic,isc),id=1,nd)
      end do
C
      stop
