...
C
      DO ICASE=1,2
        ...
        if(ICASE==1) OPEN(IUD1,file="o"//cn//"_"//cd//"d"//cl//".d",
     &                 form="unformatted",status="old")
        if(ICASE==2) OPEN(IUD1,file="o"//cn//"_"//cd//"d"//cl//"m.d"
     &                ,form="unformatted",status="old")
...
C
        ...
        if(ICASE==1) OPEN(IUD1,file="a"//cn//"_"//cd//"d"//cl//".d",
     &                     form="formatted",status="unknown")
        if(ICASE==2) OPEN(IUD1,file="a"//cn//"_"//cd//"d"//cl//"m.d",
     &                     form="formatted",status="unknown")
        DO IT=0,NT,NSTEP
